...
final class FoodData111 {
  ...
  init() {
    list.append(Food(iconImage: "TarteMain", title: "티라미스 타르트", level: "Level : ★ ★ ★ ★ ☆ ", comment: ["something", "mmm"],
                foodMeterial: [("진저브래드 쿠키믹스", "1개"),("달걀노른자", "1개"),("버터", "80g"),("우유", "15ml"),("초코시트", "1장"),("설탕", "30g"),("생크림", "200ml"),("크림치즈", "250g"),],
                meterialImages: ["TarteMeterial"],
                recipe: [
                  "Step1:   볼에 쿠키믹스,달걀노른자,버터,우유를 넣고",
                  "              핸드믹서 거품기로 섞어주세요.",
                  "Step2:   STEP1의 반죽 재료를 비닐에 넣어 뭉쳐준 후",
                  "밀대로 밀어 타르트팬에 넣어주세요. ",
                  "Step3:   포크로 모양을 낸 후 180℃오븐에서 12분간 구운 후",
                  "              식힘망에 올려 식혀주세요.",
                  "Step4:   볼에 크림치즈, 샤워크림을 넣고 핸드믹서 거품기로",
                  "가장 약한 단계에서 섞어주세요.",
                  "Step5:   다른 볼에 생크림을 넣고가장 센 단계에서 휘핑한 후 ",
                  "              STEP6에 넣고 실리콘주걱으로 섞어주세요.",
                  "Step6:   STEP3의 타르트팬에 필링을 1/2 넣고",
                  "              초코시트를 그 위에 올려주세요.",
                  "Step7:  슈거파우더와 코코아가루로 마무리해주세요.",
      ], sensitivity: "지옥갬성", info: "인포"))
    ...
    list.append(Food(iconImage: "ChocolateMain", title: "초코칩 쿠키", level: "Level : ★ ★ ★ ★ ☆ ", comment: ["something", "mmm"],
                ...
                recipe: [
                  "Step1:   볼에 달걀,우유, 설탕,소금을 넣고 섞어주세요",
                  "Step2:   박력분과 아몬드 가루, 베이킹파우더, 베이킹 소다를",
                  "              함께 체 쳐서 섞은 후 섞어 주세요",
                  "Step3:   아몬드 슬라이스를 반죽에 넣고 섞어주세요",
                  "Step4:   볼에 랩을 씌워 실온에서 30분정도 둔 다음",
    ...
    list.append(Food(iconImage: "GrapePizzaMain", title: "포도 피자", level: "Level : ★ ☆ ☆ ☆ ☆ ", comment: ["something", "mmm"],
                ...
                recipe: [
                  "Step1:   포도는먹기 좋은 크기로 잘라 씨를 빼주세요.",
                  "             루꼴라는 깨끗이 씻어 물기를 제거해주세요. ",
                  "Step2:   토르티야에 꿀 1큰술을 넓게 바르고",
                  "             피자치즈와 포도를 골고루 올려주세요.",
                  "Step3:   200도로 오븐에서 9~10분 정도 구워주세요.",
                  "Step4:   토르티야에 루꼴라를 올리고",
                  "             파마산치즈를 뿌린 후 완성해주세요."
    ...
    list.append(Food(iconImage: "ApplePieMain", title: "애플 파이", level: "Level : ★ ★ ★ ★ ☆ ", comment: ["something", "mmm"],
                ...
                recipe: [
                  "Step1:   넓은 볼에 체를 받쳐 밀가루를 내린 후",
                  "           설탕, 소금 넣어 섞고 차가운버터를 넣고 ",
                  "           버터가 0.2cm크기가 될 때까지 반죽해주세요.",
                  "Step2:   반죽이 부슬부슬한 상태가 되면 ",
                  "           찬물과 달걀노른자를 넣고 섞어주세요.",
                  "Step3:   가루가 보이지 않을때 한 덩어리로 뭉치고",
                  "           납작하게 눌러 1시간 휴지시켜주세요. ",
                  "Step4:   사과는 1cm두께로 납작하게 썰어주세요.",
                  "           버터를 녹인 냄비에 사과와 필링재료를 넣고",
                  "           15분간 졸여준 후 체에 밭쳐서 완전히 식혀주세요.",
                  "Step5:   반죽을 반으로 나눈 후 밀어주세요.",
                  "Step6:   파이틀에 반죽을 올려서 안쪽에 붙여주세요.",
                  "Step7:   바닥에 사과필링을 채워주세요.",
                  "Step8:   파이 윗면과 테두리에 달걀물을 발라주세요",
                  "Step9:   180도로 예열한 오븐에서 약 45분 구워준 후",
    ...
    list.append(Food(iconImage: "CakeMain", title: "복숭아 타르트", level: "Level : ★ ★ ★ ☆ ☆ ",
                ...
                recipe: [
                  "Step1:  복숭아는 버리고 과육만 따로 준비합니다.",
                  "Step2:  달걀과 우유, 식용유를 볼에 넣고 ",
                  "          거품기로 섞어준 후 머핀믹스를 넣고",
                  "          반죽을 버터를 바른 타르트 틀에 부어주세요",
                  "Step3:  타르트틀은 반죽보다 높은것을 준비해서 ",
                  "   복숭아를 얇게 슬라이스하여 보기 좋게 올려줍니다",
                  "Step4:  170℃로 오븐에서 25분 구워 완성합니다.",
      ], sensitivity: "지옥갬성", info: "인포"))
